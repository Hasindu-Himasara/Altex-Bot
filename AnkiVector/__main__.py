...
buttons = [
    [
        InlineKeyboardButton(text="🛠 UPDATES CHANNEL 🛠", url="https://t.me/TECH_WIDE_OFFCIAL"),
    ...
    [
        InlineKeyboardButton(
            text="➕ Altex Bot ADD YOUR GROUP ➕", url="t.me/TheAnkiVectorbot?startgroup=true"
        ),
    ],
]
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        update.effective_message.reply_text(
            "You can donate and send a message to this Telegram Username. @HASINDUHIMASARA"
            "[here]({})".format(DONATE_LINK),
            parse_mode=ParseMode.MARKDOWN,
        )
