...
from AnkiVector.services.telethon import tbot
    ...
    if event.reply_to_msg_id:
        ...
        if input_str == "m":
            ...
            try:
                ...
                os.remove(downloaded_file_name)
                await h.edit(
                    "Uploaded to https://telegra.ph{} in {} seconds.𝑷𝒐𝒘𝒆𝒓𝒅 𝒃𝒚 @AltexSL_BOT".format(
            ...
            ms = (end - start).seconds
            await event.reply(
                "Pasted to https://telegra.ph/{} in {} seconds.𝑷𝒐𝒘𝒆𝒓𝒆𝒅 𝒃𝒚 @AltexSL_BOT".format(
                    response["path"], ms
                ),
                link_preview=True,
            )
